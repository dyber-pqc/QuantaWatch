...
export interface NavItem {
  ...
  /** Which live-count badge to show (resolved in the shell). */
  badge?: "criticalPaths" | "openPlans" | "vulnerableEndpoints" | "alerts";
  /** Optional one-click action shown on hover. */
    ...
    items: [
      {
        to: "/estate",
        label: "Estate",
        quickAction: { label: "Register an asset", to: "/estate" },
        icon: (
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      },
      {
        ...
        label: "Attack Paths",
        badge: "criticalPaths",
        quickAction: { label: "Open attack paths", to: "/attack-paths" },
        icon: (
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
